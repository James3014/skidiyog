...
$exchangeRate = $ko->getExchageRate();//_v($exchangeRate);
        ...
        <!--class table-->
         ...
         <div class="row container-xl">
           <div class="col s12 m10 col-centered">
                    ...
                    <h5>費用總計</h5>
                     <div class="row sum-block">
                          ...
                          <div class="card-panel">
                            <div class="row flex-stretch">
                              ...
                              <div class="col s12 m3 payment-sum">
                                ...
                                <div id="paid" class="cR"><p class="num col s8 m12"><?=number_format($order['prepaid'])?> <small class="badge badge-primary"><?=$order['currency']?></small></p></div>
                                ...
                                <p class="num col s8 m12"><br><?=number_format(round($order['paid']/$exchangeRate['RMB']))?> <small class="badge badge-primary">RMB</small></p>
                              </div>
                              <div class="col s12 m3 payment-sum">
                      ...
                      <div class="row">
                        ...
                        <br>
                        <span style="color: red; font-size:1rem;">＊此付款連結為一次性付款，當點擊下方『信用卡付款』後，需完成線上刷卡手續。付款流程中若未完成，請重新索取付款連結。謝謝您的配合與諒解～</span>
                        </div>
                      </div>
                    </td>
                  </tr>
            ...
            <div class="row space-top-1 center">
            <div class="row">
              <div class="col s12 m6 center-align">
                <table>
                  <tr>
                    <td style="text-align:right;"><img src="/assets/images/wechat.jpg" style="height:5rem;"></td>
                    <td><b>使用微信轉帳</b> $<b><cB><?=number_format(round($order['paid']/$exchangeRate['RMB']))?></cB></b> RMB<br>請加入微信ID: <b><cB>Liligogo523</cB></b><br>轉帳後請告知訂單編號 <b><cB>#<?=$oidx?></cB></b></td>
                  </tr>
                </table>
              </div>
            </div>
