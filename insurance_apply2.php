                    ...
                    success: function(resp){
                        //alert("Successfully submitted."+resp)
                            if(resp==101005){ // user profile verify & MAIL CHECK PASS
                                ...
                                //$('#ERRMSG').text('資料填寫不完整');
                                $('#PERRMSG').text('提醒您： 被保人姓名、護照號碼及身分證字號是必填資料唷！');
                                $('#err_msg').modal('open'); 
                            }else{
                                $('#err_msg').modal('open');                                
                            }                         
                 ...
                 <div class="col s12 l8 col-centered center">
                    ...
                    <form class="col s12 space-top-2" id="accountinfo-form">
                      ...
                      <div class="input-field col s12 m6">
                        ...
                        <input name="p_no" type="text" value="<?= $insuranceResult['pnumber']; ?>" placeholder="（必填）">
                      </div>
                      ...
                      <div class="input-field col s12 m6">
                        <label for="" class="active">滑雪天數: </label>
                      ...
                      <div class="input-field col s12 m6">
                        <label for="" class="active">未滿16歲，請填父母姓名</label>
